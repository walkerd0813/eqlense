...
$py = "scripts\phase5\hampden_axis2_postmatch_fuzzy_range_v1_31.py"
...
Write-Host "Mechanical analyzer:"
Write-Host "  python .\scripts\phase5\probe_axis2_nomatch_mechanical_analyzer_v1.py --in `"$Out`""
