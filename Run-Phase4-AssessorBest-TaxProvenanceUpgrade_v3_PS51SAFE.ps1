...
$CONFIG = Join-Path $ROOT 'phase4_assessor_best_provenance_upgrade_config_v3.json'
$NODE = 'node'
$NODE_SCRIPT = Join-Path $ROOT 'scripts\phase4_assessor\phase4_assessor_best_provenance_upgrade_v3.mjs'

Write-Host "[start] Phase4 assessor_best tax_fy provenance upgrade (v3 runner)"
