#!/usr/bin/env python3
"""
stitch_townblocks_pagebreak_continuations_v1_5_3.py
...
def main():
    ...
    counts = {
        ...
        "notes": "v1_5_3 stitches refs+parties from top-of-next-page raw OCR lines; supports --raw and --raw_lines_ndjson."
    }
    samples: List[dict] = []
    ...
    with open(args.qa_path, "w", encoding="utf-8") as f:
        json.dump({
            "engine": "stitch_townblocks_pagebreak_continuations_v1_5_3",
