...
def base.__dict__["stitch_event"](last_ev, *, from_page, into_page, refs_found, parties_found, captured, counts, samples, continuation_type: str):
    """
    Older frozen stitchers may not accept continuation_type kwarg.
    Try with it; on TypeError retry without; record type in meta.
    """
    try:
        base.__dict__["stitch_event"](last_ev,
            from_page=from_page,
            into_page=into_page,
