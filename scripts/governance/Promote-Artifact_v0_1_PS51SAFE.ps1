...
if($Provisional){
  & powershell -ExecutionPolicy Bypass -File $probeGate -Root $Root -MaxAgeHours 24 -AllowProvisional
} else {
  & powershell -ExecutionPolicy Bypass -File $probeGate -Root $Root -MaxAgeHours 24
}
# ----------------------------------------------------------------
