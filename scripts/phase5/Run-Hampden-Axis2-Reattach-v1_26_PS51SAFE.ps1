...
$audit = ($Out -replace '\.ndjson$','') + "__audit_v1_26.json"

# One-line command to avoid PowerShell parsing '--'
python .\scripts\phase5\hampden_axis2_reattach_axis2_ge10k_v1_26.py --events "$Events" --spine "$Spine" --out "$Out" --audit "$audit" --max_samples 30
