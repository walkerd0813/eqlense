...
OUT_PATH = r"publicData/registry/hampden/_attached_DEED_ONLY_v1_8_1_MULTI/axis2_candidates_ge_10k__reattached_axis2_v1_12.ndjson"
AUDIT    = r"publicData/_audit/registry/hampden_axis2_reattach_ge10k_v1_12.json"
...
def segment_by_dash(raw_block: str, town0: str, addr0: str, docno_raw: str|None):
    ...
    doc_pat = docno_re
    for c in chunks:
                if doc_pat and doc_pat.search(c):
...
print("=== AXIS2 REATTACH (>=10k) v1_12 ===")
