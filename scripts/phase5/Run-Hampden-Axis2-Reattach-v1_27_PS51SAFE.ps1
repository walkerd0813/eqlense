...
$audit = ($Out -replace '\.ndjson$','') + "__audit_v1_27.json"

python .\scripts\phase5\hampden_axis2_reattach_axis2_ge10k_v1_27.py --events "$Events" --spine "$Spine" --out "$Out" --audit "$audit" --max_samples 30
