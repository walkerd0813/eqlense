...
Write-Host "===================================================="
Write-Host "PHASE 3 — UTILITIES FIX DISPLAY NAMES (PS 5.1 SAFE) v1"
Write-Host "===================================================="
...
function Fix-Text([string]$s) {
  ...
  # Common mojibake forms we saw: "â€”" "Ã¢â‚¬â€" etc.
  $t = $s
  $t = $t -replace "Ã¢â‚¬â€", "—"
  $t = $t -replace "â€”", "—"
  $t = $t -replace "â€“", "–"
...
# Preserve any dropped metadata if present
$outObj = [ordered]@{
