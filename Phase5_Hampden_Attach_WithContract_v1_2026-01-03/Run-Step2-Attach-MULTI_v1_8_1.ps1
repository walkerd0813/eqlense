...
$outDir = Join-Path $BackendRoot "publicData\registry\hampden\_attached_DEED_ONLY_v1_8_1_MULTI"
if (!(Test-Path $outDir)) { New-Item -ItemType Directory -Path $outDir | Out-Null }

$out = Join-Path $outDir "events_attached_DEED_ONLY_v1_8_1_MULTI.ndjson"
$audit = Join-Path $BackendRoot "publicData\_audit\registry\hampden_step2_attach_DEED_ONLY_v1_8_1_MULTI.json"
